# ProDesk – IT Intern Projects 🚀<br>

Welcome to **ProDesk**, a curated collection of projects developed during my **IT Internship**.  
This repository showcases hands-on work in **web development**, **JavaScript**, and **problem-solving**, focusing on real-world use cases and clean code practices.

---

## 📁 Repository Structure<br>

Each project is organized into its own folder for clarity and scalability.<br>
## 📌 Projects Included

### 🔹 1. ProDesk Landing Page
**Folder:** `project-1-prodesk-landing`  
...
GitHub: https://github.com/vee91-af<br>
✨ Feel free to explore, fork, or give a ⭐ if you like the work!
